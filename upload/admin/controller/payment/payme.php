...
class ControllerPaymentPayme extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			/*
			$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = 0, `group` = 'payme', `key` = 'Order Status', `value` = '1'");
			$this->db->query("INSERT INTO " . DB_PREFIX . "setting SET store_id = 0, `group` = 'payme', `key` = 'Sort Order',   `value` = '0'");
			*/
